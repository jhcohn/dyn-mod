...
outname = 'output_vel_theta_offsetbh0.fits'
x_off = 0#10
y_off = 0#15
...
# ** ALREADY INSTALLED IN iraf27 environ
# Task (in pyraf): lucy (stdas)
...
for x in range(len(x_obs)):
    ...
    plt.scatter(xtemp, y_obs, c=v_obs[x, :], vmin=-10**3., vmax=10**3., s=25, cmap='RdBu_r')  # viridis, RdBu_r, inferno
print(theta)
