...
if __name__ == "__main__":
    ...
    params, priors = dm.par_dicts(parfile)  # get dicts of params and file names from parameter file
    '''
    print(priors['inc'])
    ...
    maxc = 100000
    # n_eff = 100000
    out_name = direc + 'dyndyn3258_test_n' + str(params['nprocs']) + '_' + str(time.time()) + '_tempsave' +  '.pkl'
    print(out_name)
    ...
    if params['nprocs'] > 1:
        ...
        print('pool assigned', str(time.time()-tb))
    ...
    import pickle
    out_name = direc + 'dyndyn3258_test_n' + str(params['nprocs']) + '_' + str(time.time()) + '_end.pkl'
