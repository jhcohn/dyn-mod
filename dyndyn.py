...
# PARAMETER FILE
parfile = '/Users/jonathancohn/Documents/dyn_mod/ugc_2698/ugc_2698_params.txt'  # BUCKET
...
for i in range(dyn_res['samples'].shape[1]):  # for each parameter
    quantiles_3 = dyfunc.quantile(res['samples'][:, i], [0.025, 0.5, 0.975], weights=weights)
...
import pickle
out_name = direc + 'dyndyn_test_' + str(time.time()) + '.pkl'
