...
if __name__ == "__main__":
    ...
    maxc = 100000
    # n_eff = 100000
    out_name = direc + 'dyndyncluster_test_n' + str(params['nprocs']) + '_' + str(time.time()) + '_tempsave' +  '.pkl'
    ...
    import pickle
    out_name = direc + 'dyndyncluster_test_n' + str(params['nprocs']) + '_' + str(time.time()) + '.pkl'
